"""
Django settings for aged_rice_38714 project.
...
ROOT_URLCONF = 'aged_rice_38714.urls'
...
WSGI_APPLICATION = 'aged_rice_38714.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_rice_38714 API",
    "DESCRIPTION": "API documentation for aged_rice_38714 App",
    "VERSION": "v1",
}
